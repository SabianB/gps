            ...
            <div class="row">
                <div class="col">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Horarios de salida</li>
                    </ol>
                </div><!--end col-->
            </div><!--end row-->
...
<div class="row" style="height: 95%">
    <div class="col-lg-2">
        <div class="container mt-5">
            ...
            <div class="row mt-3">
                <div class="col text-center">
                    <button class="btn btn-success" onclick="objHorarios.search(fechaini, fechafin, 4, false, true)">Buscar</button>
                </div>
            </div>
            <div class="row mt-3">
                <div class="col text-center">
                    <button class="btn btn-success" onclick="objMapa.ReportePorTabla('Horarios_Salida')">Generar reporte</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card mb3">
                <div class="card-body">
                    <div id="containerTableItems" class="table-responsive">
                        <table id="horariotable" class="table table-bordered dt-responsive nowrap"
...
<div class="modal fade" id="horariosModal" tabindex="-1" aria-labelledby="exampleModalFullscreenLabel" aria-hidden="true">
